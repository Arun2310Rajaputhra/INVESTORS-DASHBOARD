...
<style>
    ...
    .stApp {{
        background: linear-gradient(rgba(0, 15, 40, 0.85), rgba(0, 15, 40, 0.9)),
                    url('https://raw.githubusercontent.com/Arun2310Rajaputhra/INVESTORS-DASHBOARD/main/background%20website.jpg');
...
def main():
    ...
    <div class="main-header">
        <img src="https://raw.githubusercontent.com/Arun2310Rajaputhra/INVESTORS-DASHBOARD/main/title%20header.jpg" 
